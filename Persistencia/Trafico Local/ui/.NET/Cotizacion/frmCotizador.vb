    ...
    Private Sub btnCalcular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCalcular.Click
        ...
        If ValidaDatos() Then
            ...
            Dim oConexion As SqlClient.SqlConnection = _
                New SqlClient.SqlConnection("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=InterPrueba;Data Source=ARCHIVOS")
            ...
            Try
                ...
                With oCommand.Parameters
                    ...
                    .AddWithValue("@Origen", Convert.ToInt32(Me.cmbOrigen.SelectedValue))
                    .AddWithValue("@TipoViaje", Convert.ToBoolean(Bit_Full))
                    .AddWithValue("@TipoRemolque", Convert.ToInt32(Tipo_Remolque))
                    .AddWithValue("@Bit_Seguro", Convert.ToBoolean(Me.CheckBox1.Checked))
                    .AddWithValue("@TipoCotizacion", Tipo_Cotizacion)
            ...
            If Tipo_Cotizacion = 1 Then  ' Sencillo
            ...
            Else
                ...
                If Tipo_Cotizacion = 2 Then ' full
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    ' kilometros / rendimiento de diesel
                    ...
                    If cmbTipoViaje.SelectedItem = "Sencillo" Then
                        ...
                        End If
                        ' se tiene que calcular los dos rendimientos por si se quiere revisar cotizacion de full y sencillo a la vez
                        CtoDieConsuSen = CDbl(Me.TxtCtoDieConsumo.Text)

                        If rendiefull = 0 Then  ' si no hay rendimiento diesel para full se toma el del sencillo
